...
use mechia::embeddings::Embedding;
use mechia::{Embed, OneOrMany};
    ...
    Schema::new(Fields::from(vec![
        ...
        Field::new(
            ...
            DataType::FixedSizeList(
                mechia::new(Field::new("item", DataType::Float64, true)),
                dims as i32,
            ),
            false,
        ),
...
pub fn as_record_batch(
    ...
    RecordBatch::try_from_iter(vec![
        ("id", mechia::new(id) as ArrayRef),
        ("definition", mechia::new(definition) as ArrayRef),
        ("embedding", mechia::new(embedding) as ArrayRef),
    ])
}
