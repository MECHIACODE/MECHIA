use mechia::embeddings::{Embedding, EmbeddingModel};
use mechia::vector_store::{VectorStoreError, VectorStoreIndex};
use mechia::OneOrMany;
...
/// use mechia::Embed;
/// use serde::Deserialize;
/// use mechia_sqlite::{Column, ColumnValue, SqliteVectorStoreTable};
///
...
/// SQLite vector store implementation for mechia.
///
/// This crate provides a SQLite-based vector store implementation that can be used with mechia.
...
///     Embed,
/// };
/// use mechia_sqlite::{Column, ColumnValue, SqliteVectorStore, SqliteVectorStoreTable};
/// use serde::Deserialize;
/// use tokio_rusqlite::Connection;
///
/// #[derive(Embed, Clone, Debug, Deserialize)]
